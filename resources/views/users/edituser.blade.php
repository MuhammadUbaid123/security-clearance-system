        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="#" method="POST" autocomplete="off" id="edit_user_form" @submit.prevent="update_user()">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" v-model="email" id="email" type="email" placeholder="Enter Email" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function(){
            edituserApp.populate_edit_data();
        });
    </script>
